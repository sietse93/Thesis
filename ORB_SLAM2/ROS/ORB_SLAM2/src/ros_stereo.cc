...
*/
    ...
    message_filters::Subscriber<sensor_msgs::Image> left_sub(nh, "/camera_left/image_raw", 1);
    message_filters::Subscriber<sensor_msgs::Image> right_sub(nh, "/camera_right/image_raw", 1);
