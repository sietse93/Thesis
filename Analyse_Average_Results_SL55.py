...
# file locations
file_string_static = "/home/sietse/official_experiment_data/SL_55_NV_0_SV_1_orb_{}.txt"
file_string_dynamic = "/home/sietse/official_experiment_data/SL_55_NV_40_SV_1_orb_{}.txt"
file_gt_dyn = "/home/sietse/official_experiment_data/SL_55_NV_40_SV_1_gt.txt"
file_gt_stat = "/home/sietse/official_experiment_data/SL_55_NV_0_SV_1_gt.txt"
...
#for i in range(1):
# orb_static_objects.pop()
orb_dynamic_objects.pop(2)
...
with ScenarioProcessor(flocation=flocation, SL=55, NV=40) as SP:
...
# hero_index = hero.time.index(encountered_vehicles[4].encounter_data[0][0])
# print(hero.data[hero_index+1])
