...
# file locations
file_string_static = "/home/sietse/official_experiment_data/SL_144_NV_0_SV_1_orb_{}.txt"
file_string_dynamic = "/home/sietse/official_experiment_data/SL_144_NV_40_SV_1_orb_{}.txt"
file_gt_dyn = "/home/sietse/official_experiment_data/SL_144_NV_40_SV_1_gt.txt"
file_gt_stat = "/home/sietse/official_experiment_data/SL_144_NV_0_SV_1_gt.txt"
...
#for i in range(1):
# orb_static_objects.pop(2)
#orb_dynamic_objects.pop(3)
...
for obj in orb_dynamic_objects:
    orb_all.append(obj)
    gt_list.append(gt_dyn)
# for j in range(l_orb):
#     orb_all.append(orb_static_objects[j])
#     orb_all.append(orb_dynamic_objects[j])
#     gt_list.append(gt_static)
#     gt_list.append(gt_dyn)
...
with ScenarioProcessor(flocation=flocation, SL=144, NV=40) as SP:
