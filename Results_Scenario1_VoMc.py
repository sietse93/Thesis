...
plt.suptitle("Results Town {}: ORB without relocalization (ORB VO) and without map point culling (ORB MC)".format(Town), fontsize=18, fontweight='bold', y=0.95)
ind = np.arange(len(x))
...
plt.plot([], [], color='blue', label="ORB VO mode: no relocalization")
