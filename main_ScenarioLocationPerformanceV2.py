...
class ScenarioPerformance:
        ...
        for data in list_scenario_performance:
            ...
            for dict in dict_list:
                ...
                if dict["Location"] == location_string:
                    ...
                    dict["d{}_trans_per".format(ds)] = (trans_dynamic - trans_static) / trans_static * 100.0
                    ...
                    dict["d{}_rot_per".format(ds)] = (rot_dynamic - rot_static) / rot_static * 100.0
    ...
    def CreateLatexTableDiscussionTrans(self, dict_list):
        ...
        for dict in dict_list:
            ...
            dic_data = "& {:.3f} & {:.3f} & {:.1f} & {:.3f} & {:.1f}".format(dict["Static_trans"],
                                                         dict["d20_trans"],
                                                         dict["d20_trans_per"],
                                                         dict["d15_trans"],
                                                         dict["d15_trans_per"])
    ...
    def CreateLatexTableDiscussionRot(self, dict_list):
        ...
        for dict in dict_list:
            ...
            column0 = "T{}Nr{}".format(town_nr, traj_index)
            dic_data = "& {:.3f} & {:.3f} & {:.1f} & {:.3f} & {:.1f}".format(dict["Static_rot"],
                                                                             dict["d20_rot"],
                                                                             dict["d20_rot_per"],
                                                                             dict["d15_rot"],
                                                                             dict["d15_rot_per"])
