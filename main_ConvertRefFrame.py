...
def main():
	...
	base_dir = "/home/sietse/results_carla0.9/stuckbehindvan/test/"

	Towns = (1, 2)
	scenario = "static"
	# dynamic_variables = (20, 15, 10)
	dynamic_variable = 10
	Town = 1
	mode = "SLAM"
	# for Town in Towns:
	...
	if scenario == "dynamic":
		...
		for i in range(5):
			if mode == "SLAM":
				...
				file_name = "T{}_SL{}_{}{}_orb_NoVm_{}.txt".format(Town, SL, scenario[0], DS, i)
		...
		for i in range(5):
			...
			if mode == "SLAM":
				...
				file_name = "T{}_SL{}_{}_orb_vo_{}.txt".format(Town, SL, scenario[0], i)
			elif mode == "MC":
				file_name = "T{}_SL{}_{}_orb_mc_off_{}.txt".format(Town, SL, scenario[0], i)
			elif mode == "NOVM":
				file_name = "T{}_SL{}_{}_orb_NoVm_{}.txt".format(Town, SL, scenario[0], i)
