...
from evaluate_RPE_time_da_colloq import evaluate_RPE_time_da_colloq
...
time_RPE = 1.0
colloq_vehicles = encountered_vehicles[0:5]
evaluate_RPE_time_da_colloq(GT, SLAM, time_RPE, colloq_vehicles)
